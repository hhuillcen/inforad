 ...
 */
public class pred1d extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
       ...
       getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
        ...
        setContentView(R.layout.pred1d);
        ...
        txthv.setText("Predicciones de radiación UV para el día de hoy : "+dia+"-"+mes+"-"+anio);
        txttemp.setText("Predicciones de Temperatura para el día de hoy : "+dia+"-"+mes+"-"+anio);
        ...
        try
        {
            ...
            File f = new File(ruta_sd.getAbsolutePath(), "predict.txt");
        ...
        try
        {
            ...
            File f = new File(ruta_sd.getAbsolutePath(), "uv_actual.txt");
    ...
    //////////////////// fin deecarga y cargado de datos
        ...
        Number[] uv={Float.parseFloat(h600),
                Float.parseFloat(h630),
                Float.parseFloat(h700),
                Float.parseFloat(h730),
                Float.parseFloat(h800),
                Float.parseFloat(h830),
                Float.parseFloat(h900),
                Float.parseFloat(h930),
                Float.parseFloat(h1000),
                Float.parseFloat(h1030),
                Float.parseFloat(h1100),
                Float.parseFloat(h1130),
                Float.parseFloat(h1200),
                Float.parseFloat(h1230),
                Float.parseFloat(h1300),
                Float.parseFloat(h1330),
                Float.parseFloat(h1400),
                Float.parseFloat( h1430),
                Float.parseFloat(h1500),
                Float.parseFloat(h1530),
                Float.parseFloat(h1600),
                Float.parseFloat(h1630),
                Float.parseFloat(h1700),
                Float.parseFloat(h1730),
                Float.parseFloat(h1800)
                };

        Number[] uv_actual={Float.parseFloat(a600),
                Float.parseFloat(a630),
                Float.parseFloat(a700),
                Float.parseFloat(a730),
                Float.parseFloat(a800),
                Float.parseFloat(a830),
                Float.parseFloat(a900),
                Float.parseFloat(a930),
                Float.parseFloat(a1000),
                Float.parseFloat(a1030),
                Float.parseFloat(a1100),
                Float.parseFloat(a1130),
                Float.parseFloat(a1200),
                Float.parseFloat(a1230),
                Float.parseFloat(a1300),
                Float.parseFloat(a1330),
                Float.parseFloat(a1400),
                Float.parseFloat(a1430),
                Float.parseFloat(a1500),
                Float.parseFloat(a1530),
                Float.parseFloat(a1600),
                Float.parseFloat(a1630),
                Float.parseFloat(a1700),
                Float.parseFloat(a1730),
                Float.parseFloat(a1800)
        };
        ...
        XYSeries series2 = new SimpleXYSeries(
                Arrays.asList(series1Numbers),          // SimpleXYSeries takes a List so turn our array into a List
                Arrays.asList(uv_actual),
                "UV real");

        PointLabelFormatter plf = new PointLabelFormatter();
        plf.getTextPaint().setTextSize(1);
        plf.getTextPaint().setColor(Color.BLACK);

        PointLabelFormatter plf1 = new PointLabelFormatter();
        plf1.getTextPaint().setTextSize(14);
        plf1.getTextPaint().setColor(Color.RED);
        ...
        LineAndPointFormatter series1Format = new LineAndPointFormatter(Color.rgb(0, 200, 0),Color.rgb(0, 100, 0),Color.CYAN,plf);
                                    // fill color
        LineAndPointFormatter series2Format = new LineAndPointFormatter(Color.rgb(200, 0, 0),Color.rgb(100, 0, 0),null,plf1);
       ...
       // plot.getGraphWidget().getDomainLabelPaint().setTextSize(22);
        ...
        try
        {
            ...
            File f = new File(ruta_sd.getAbsolutePath(), "predicttemp1d.txt");
        ...
        try
        {
            ...
            File f = new File(ruta_sd.getAbsolutePath(), "temp_actual.txt");
        ...
        Number[] temp_actual={
                Math.rint(Float.parseFloat(a600)*10)/10,
                Math.rint(Float.parseFloat(a630)*10)/10,
                Math.rint(Float.parseFloat(a700)*10)/10,
                Math.rint(Float.parseFloat(a730)*10)/10,
                Math.rint(Float.parseFloat(a800)*10)/10,
                Math.rint(Float.parseFloat(a830)*10)/10,
                Math.rint(Float.parseFloat(a900)*10)/10,
                Math.rint(Float.parseFloat(a930)*10)/10,
                Math.rint(Float.parseFloat(a1000)*10)/10,
               Math.rint(Float.parseFloat(a1030)*10)/10,
                Math.rint(Float.parseFloat(a1100)*10)/10,
                Math.rint(Float.parseFloat(a1130)*10)/10,
                 Math.rint(Float.parseFloat(a1200)*10)/10,
                Math.rint(Float.parseFloat(a1230)*10)/10,
                 Math.rint(Float.parseFloat(a1300)*10)/10,
                 Math.rint(Float.parseFloat(a1330)*10)/10,
                 Math.rint(Float.parseFloat(a1400)*10)/10,
                 Math.rint(Float.parseFloat(a1430)*10)/10,
                Math.rint(Float.parseFloat(a1500)*10)/10,
                 Math.rint(Float.parseFloat(a1530)*10)/10,
                 Math.rint(Float.parseFloat(a1600)*10)/10,
                 Math.rint(Float.parseFloat(a1630)*10)/10,
                 Math.rint(Float.parseFloat(a1700)*10)/10,
                 Math.rint(Float.parseFloat(a1730)*10)/10,
                  Math.rint(Float.parseFloat(a1800)*10)/10
        };
        ...
        XYSeries series4 = new SimpleXYSeries(
                Arrays.asList(series3Numbers),          // SimpleXYSeries takes a List so turn our array into a List
                Arrays.asList(temp_actual),
                "Temp. actual");
        ////////////////////////////////////////////
        PointLabelFormatter plf3 = new PointLabelFormatter();
        plf3.getTextPaint().setTextSize(0);
        plf3.getTextPaint().setColor(Color.BLACK);

        PointLabelFormatter plf4 = new PointLabelFormatter();
        plf4.getTextPaint().setTextSize(14);
        plf4.getTextPaint().setColor(Color.RED);

        // Create a formatter to use for drawing a series using LineAndPointRenderer:
        LineAndPointFormatter series3Format = new LineAndPointFormatter(Color.rgb(0, 200, 0),Color.rgb(0, 100, 0),Color.CYAN,plf3);

        LineAndPointFormatter series4Format = new LineAndPointFormatter(Color.rgb(200, 0, 0),Color.rgb(100, 0, 0),null,plf4);
        // fill color
        // setup our line fill paint to be a slightly transparent gradient:
        ...
        plot1.addSeries(series4, series4Format);
